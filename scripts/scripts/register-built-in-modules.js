...
// ============================================================================
async function registerModuleContext(moduleId, moduleName, aiContext) {
    try {
        ...
        if (existing) {
            ...
            await prisma.moduleAIContextRegistry.update({
                ...
                data: {
                    ...
                    contextProviders: aiContext.contextProviders,
                    queryableData: aiContext.queryableData,
                    relationships: aiContext.relationships,
                    fullAIContext: aiContext,
