...
router.put('/admin/swaps/:id/approve', checkSchedulingAdmin, idParam, schedulingController.approveShiftSwapAdmin);
router.put('/admin/swaps/:id/deny', checkSchedulingAdmin, idParam, schedulingController.denyShiftSwapAdmin);
...
router.put('/team/swaps/:id/approve', checkSchedulingManagerAccess, idParam, schedulingController.approveShiftSwapManager);
router.put('/team/swaps/:id/deny', checkSchedulingManagerAccess, idParam, schedulingController.denyShiftSwapManager);
...
router.put('/me/availability/:id', checkSchedulingEmployeeAccess, checkSchedulingSelfAccess, idParam, schedulingController.updateOwnAvailability);
