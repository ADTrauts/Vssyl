# HISTORICAL / NON-AUTHORITATIVE (archived Batch 1C-4C)

**Status:** Historical proposal / implementation planning only. **Not** current commercial pricing policy or billing architecture SoT.

Current commercial open questions: `memory-bank/commercialOpenDecisions.md`.
Billing/entitlement implementation: `docs/account-platform/PP3_BILLING_SERVICE_MODEL.md` and related PP-3 docs.
...
- Limited AI usage (50 AI requests/month)
...
### **2. Pro Tier**
**Target**: Individual users, professionals
**Price**: $29.00/month or $290.00/year (~17% discount)
**Features**:
- All modules access
- AI usage included (with monthly cap - see AI Usage Limits below)
- Ad-free experience
- Priority support

**AI Usage Limits**:
- Base monthly AI query allowance included
- Additional queries available for purchase (pay-as-you-go)
- Usage tracking and alerts

### **3. Business Basic Tier**
**Target**: Small to medium businesses
**Price**: $49.99/month or $499.99/year (~17% discount)
**Per-Employee**: $5.00/month per employee (after 10 included employees)
**Included Employees**: 10 employees
**Features**:
- All modules access
- Basic AI settings
- Team management
...
**Example Pricing**:
- 15 employees = $49.99 + (5 × $5.00) = $74.99/month
- 25 employees = $49.99 + (15 × $5.00) = $124.99/month

### **4. Business Advanced Tier**
**Target**: Growing businesses
**Price**: $69.99/month or $699.99/year (~17% discount)
**Per-Employee**: $5.00/month per employee (after 10 included employees)
**Included Employees**: 10 employees
**Features**:
...
**Example Pricing**:
- 20 employees = $69.99 + (10 × $5.00) = $119.99/month
- 50 employees = $69.99 + (40 × $5.00) = $269.99/month

### **5. Enterprise Tier**
**Target**: Large organizations
**Price**: $129.99/month or $1,299.99/year (~17% discount)
**Per-Employee**: $5.00/month per employee (after 10 included employees)
**Included Employees**: 10 employees
**Features**:
...
**Example Pricing**:
- 50 employees = $129.99 + (40 × $5.00) = $329.99/month
- 100 employees = $129.99 + (90 × $5.00) = $579.99/month
...
**Enterprise Add-ons** (Available for Enterprise tier):
...
## AI Usage Limits & Overage Pricing

### AI Query Limits by Tier
- **Free Tier**: 50 AI queries/month (hard limit)
- **Pro Tier**: Base allowance included (e.g., 1,000 queries/month), additional queries available for purchase
- **Business Basic**: Base allowance included, team-wide pooling
- **Business Advanced**: Higher base allowance, team-wide pooling
- **Enterprise**: Unlimited AI usage

### Additional AI Query Purchases (Cursor-style)
Users on Pro tier and above can purchase additional AI query packs:
- **Small Pack**: 500 queries for $10.00
- **Medium Pack**: 2,500 queries for $40.00 (20% discount)
- **Large Pack**: 5,000 queries for $70.00 (30% discount)
- **Enterprise Pack**: 10,000 queries for $120.00 (40% discount)

**Note**: Purchased queries roll over month-to-month and never expire.

### Other Usage Overages
- **Storage Overages**: $0.10 per GB over tier limit
- **API Call Overages**: $0.01 per additional API call (for non-AI API calls)
