...
**Status:** Historical enterprise-module enhancement plan. **Not** current commercial or architecture SoT.

Settled product principle (active): enhance existing modules rather than enterprise forks — see `memory-bank/enterpriseModuleStrategy.md` stub and `memory-bank/commercialOpenDecisions.md`.
