...
**Scope:** day-to-day dev/build/database fixes. For long-form incident history (GCS, module upload, legacy 500s, etc.), see [`docs/archive/troubleshooting-historical-incidents.md`](../archive/troubleshooting-historical-incidents.md). The memory bank links here from [`memory-bank/troubleshooting.md`](../../memory-bank/troubleshooting.md) to avoid duplicate maintenance.
