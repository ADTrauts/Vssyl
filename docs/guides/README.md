...
| **Third-party modules** | [`PARTNER_DEVELOPER_GUIDE.md`](./PARTNER_DEVELOPER_GUIDE.md) (**start here — full capability**), [`THIRD_PARTY_MODULE_RULEBOOK.md`](./THIRD_PARTY_MODULE_RULEBOOK.md) (review checklist), [`THIRD_PARTY_MODULE_DEVELOPER_GUIDE.md`](./THIRD_PARTY_MODULE_DEVELOPER_GUIDE.md) (pipeline + AI index), [`THIRD_PARTY_MODULE_PIPELINE_SOURCE_OF_TRUTH.md`](./THIRD_PARTY_MODULE_PIPELINE_SOURCE_OF_TRUTH.md) (authoritative pipeline), [`full-capability-partner-module.json`](./full-capability-partner-module.json) (reference manifest), capability guides: [`SEARCH_DELEGATE_GUIDE.md`](./SEARCH_DELEGATE_GUIDE.md), [`WORKSPACE_BRIDGE_GUIDE.md`](./WORKSPACE_BRIDGE_GUIDE.md), [`ACTIVITY_INGEST_GUIDE.md`](./ACTIVITY_INGEST_GUIDE.md), [`BUSINESS_BILLING_GUIDE.md`](./BUSINESS_BILLING_GUIDE.md), [`MODULE_SCOPE_GUIDE.md`](./MODULE_SCOPE_GUIDE.md) |
