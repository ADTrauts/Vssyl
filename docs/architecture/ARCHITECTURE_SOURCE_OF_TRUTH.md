...
| **Module ContextProvider retrieval (incl. C3)** | [`AI_CONTEXT_ASSEMBLY.md`](./AI_CONTEXT_ASSEMBLY.md) + code `shouldRetrieveModuleContext` | Constitution §6.2, [`AI_CONTEXT_PROVIDER_API.md`](../guides/AI_CONTEXT_PROVIDER_API.md) | [`../../memory-bank/aiContextSystem.md`](../../memory-bank/aiContextSystem.md) (redirect) | Do not claim every Twin turn always orchestrates |
...
| **Personal memory / recall** | Mental Model (P-TRUTH) + code (`recallIntent`, `MemoryRetrievalService`) | Context assembly memory section; product meaning: [`../../memory-bank/aiProductPhilosophy.md`](../../memory-bank/aiProductPhilosophy.md) | [`../../memory-bank/AI_CONTEXT_MEMORY_ARCHITECTURE.md`](../../memory-bank/AI_CONTEXT_MEMORY_ARCHITECTURE.md) (redirect) | Not model knowledge; often `reqAuth=false` today |
...
| **AI product philosophy** | [`../../memory-bank/aiProductPhilosophy.md`](../../memory-bank/aiProductPhilosophy.md) | Mental Model, Constitution (behavioral alignment) | — | Product intent — not architecture SoT |
| **AI context provider integration** | [`AI_CONTEXT_PROVIDER_API.md`](../guides/AI_CONTEXT_PROVIDER_API.md) | [`AI_CONTEXT_ASSEMBLY.md`](./AI_CONTEXT_ASSEMBLY.md), module manifests, [`../../memory-bank/moduleSpecs.md`](../../memory-bank/moduleSpecs.md) | [`../../memory-bank/aiContextSystem.md`](../../memory-bank/aiContextSystem.md) (redirect) | Providers ≠ entire Twin context; AI only if AI-exposed |
...
| **Business Administration** | [`../business-administration/BUSINESS_ADMINISTRATION_REFERENCE_STATUS_RECORD.md`](../business-administration/BUSINESS_ADMINISTRATION_REFERENCE_STATUS_RECORD.md) | [`../business-administration/BUSINESS_ADMINISTRATION_OWNERSHIP_MODEL.md`](../business-administration/BUSINESS_ADMINISTRATION_OWNERSHIP_MODEL.md), [`BUSINESS_ADMINISTRATION_OPERATION_MATRIX.md`](../business-administration/BUSINESS_ADMINISTRATION_OPERATION_MATRIX.md) | Program archive | — |
| **Business participant composition** | [`BUSINESS_PARTICIPANT_COMPOSITION.md`](./BUSINESS_PARTICIPANT_COMPOSITION.md) | BA ownership model; [`../business-operations/WORKFORCE_IDENTITY_ARCHITECTURE.md`](../business-operations/WORKFORCE_IDENTITY_ARCHITECTURE.md); [`POLICY_ENGINE.md`](./POLICY_ENGINE.md); Product Definition glossary | Phase 1/2 participant audits | Not a Participant Engine; does **not** own AuthZ, lifecycle, HR employment, or role-aware UX design |
