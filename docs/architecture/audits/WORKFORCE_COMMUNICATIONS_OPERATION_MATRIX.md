# WORKFORCE COMMUNICATIONS OPERATION MATRIX (published BO-1A)

**Published:** docs/architecture/audits/ (BO-1A operation matrix publication)
**Canonical working copy:** [WORKFORCE_COMMUNICATIONS_OPERATION_MATRIX.md](../../business-operations/WORKFORCE_COMMUNICATIONS_OPERATION_MATRIX.md)
