...
**Version:** 1.0.0  
**Last updated:** 2026-06-24 (Marketplace Partner Capability L3 CwF — Phase 1B-G)  
...
| **Platform Kernel** | `platform_kernel` | **Partial** | **N/A** | **2 — Certified** | **LEVEL 2 CERTIFIED WITH FINDINGS** · **Platform Capability** (Activity + Domain Events composite — **not** product module) · Topology **Option C** · Ratified & executed 2026-06-23 (RD-PK-001) · G1–G9 **21/27 (~78%)** · Sub-scores: Activity **22/27**, Domain Events **21/27** · **0 blocking · 4 majors (PK-ACT-M1, M4; PK-DE-M4; PK-K-M1) · 6 advisories** · Program **ARCHIVED** — [PLATFORM_KERNEL_CERTIFICATION_RECORD](../platform-kernel/PLATFORM_KERNEL_CERTIFICATION_RECORD.md), [PLATFORM_KERNEL_GOVERNANCE_EXECUTION](../platform-kernel/PLATFORM_KERNEL_GOVERNANCE_EXECUTION.md), [PLATFORM_KERNEL_COUNCIL_DECISION](../platform-kernel/PLATFORM_KERNEL_COUNCIL_DECISION.md), [DOMAIN_EVENT_OPERATION_MATRIX](../platform-kernel/DOMAIN_EVENT_OPERATION_MATRIX.md), [PLATFORM_KERNEL_PROGRAM_ARCHIVE](../platform-kernel/PLATFORM_KERNEL_PROGRAM_ARCHIVE.md) |
...
| Domain Event Bus | Partial | High (192 types; matrix-driven) | **2 — Certified** | **L2 CwF sub-score** under `platform_kernel` (DE **21/27**) · stubs env-gated · was L1 |
| Module Activity | Partial | High (query service federation) | **2 — Certified** | **L2 CwF sub-score** under `platform_kernel` (Activity **22/27**) · ACT-R1 reads closed · was L1 |
| **Platform Kernel** | *(composite Activity + Domain Events)* | **Partial** | **N/A** | **2 — Certified** | Same row as `platform_kernel` matrix entry · Topology Option C · Program **ARCHIVED** |
...
| **Context Graph** | *(Tier 0 platform capability)* | **High** | **N/A** (federation layer — FH module patterns not applicable) | **N/A** | **4 — Certified** | **LEVEL 4 CERTIFIED WITH FINDINGS** · Consumption amendment ratified 2026-06-23 (RD-CG-L4-001) · L3 federation reaffirmed (RD-CG-010) · **#CG-1–#CG-3 (L3)** · **#CG-4 Consumption Unification (L4 CwF)** · G1–G9 **26/27 (~96%)** · **0 blocking** · **1 major (L4-F01 prod gate)** · **7 advisories** — [CONTEXT_GRAPH_L4_CERTIFICATION_RECORD](../context-graph/CONTEXT_GRAPH_L4_CERTIFICATION_RECORD.md), [CONTEXT_GRAPH_CERTIFICATION_PROMOTION_RECORD](../context-graph/CONTEXT_GRAPH_CERTIFICATION_PROMOTION_RECORD.md), [CONTEXT_GRAPH_L4_OPERATIONAL_READINESS](../context-graph/CONTEXT_GRAPH_L4_OPERATIONAL_READINESS.md) |
...
| **Unified Search** | `unified_search` | **Partial** | **N/A** (federation orchestrator — FH module SoR patterns not applicable) | **N/A** | **2 — Certified** | **LEVEL 2 CERTIFIED WITH FINDINGS** · **Platform Capability** (federated discovery — **not** product module) · Option C Hybrid · Ratified 2026-06-23 (RD-US-001) · G1–G9 **21/27 (~78%)** · **9 providers** · **0 blocking · 6 majors (SC-M1–M6) · 6 advisories** · Phase 1B governance — [SEARCH_CAPABILITY_CERTIFICATION_REVIEW](../search/SEARCH_CAPABILITY_CERTIFICATION_REVIEW.md), [SEARCH_CONSTITUTION](../search/SEARCH_CONSTITUTION.md), [SEARCH_PHASE_1B_EXECUTIVE_SUMMARY](../search/SEARCH_PHASE_1B_EXECUTIVE_SUMMARY.md), [UNIFIED_SEARCH_OPERATION_MATRIX](../search/UNIFIED_SEARCH_OPERATION_MATRIX.md) |
| **AI Retrieval Adapter** | `ai_retrieval` | **Partial** | **N/A** (AI discovery orchestrator — FH module SoR patterns not applicable) | **N/A** | **2 — Certified** | **LEVEL 2 CERTIFIED WITH FINDINGS** · **Platform Capability** (AI discovery orchestration — **not** product module) · Option B Hybrid · Ratified 2026-06-23 (RD-AR-001) · G1–G9 **20/27 (~74%)** · **2 consumers** · **0 blocking · 6 majors (AR-M1–M6) · 6 advisories** · Depends on `unified_search` · Phase 2A governance — [AI_RETRIEVAL_CAPABILITY_CERTIFICATION_REVIEW](../ai/retrieval/AI_RETRIEVAL_CAPABILITY_CERTIFICATION_REVIEW.md), [AI_RETRIEVAL_CONSTITUTION](../ai/retrieval/AI_RETRIEVAL_CONSTITUTION.md), [AI_RETRIEVAL_PHASE_2A_EXECUTIVE_SUMMARY](../ai/retrieval/AI_RETRIEVAL_PHASE_2A_EXECUTIVE_SUMMARY.md), [AI_RETRIEVAL_OPERATION_MATRIX](../ai/retrieval/AI_RETRIEVAL_OPERATION_MATRIX.md) |
| **Marketplace Partner Runtime** | `marketplace_partner_runtime` | **Partial** | **N/A** (partner delegate orchestration — FH module SoR patterns not applicable) | **N/A** | **3 — Certified** | **LEVEL 3 CERTIFIED WITH FINDINGS** · **Platform Capability** (partner delegate foundation — **not** product module) · Ratified 2026-06-24 (RD-MP-1B-G-001) · Search + Workspace + Billing + Activity + Scope · Pilot `vssyl-pilot-assets` · **0 blocking · 3 majors (F-01–F-03) · 5 advisories** · Phase 1B-G governance — [MARKETPLACE_PARTNER_CAPABILITY_CERTIFICATION_RECORD](../marketplace/MARKETPLACE_PARTNER_CAPABILITY_CERTIFICATION_RECORD.md), [MARKETPLACE_PARTNER_CAPABILITY_CERTIFICATION_REVIEW](../marketplace/MARKETPLACE_PARTNER_CAPABILITY_CERTIFICATION_REVIEW.md), [MARKETPLACE_PHASE_1B_G_EXECUTIVE_SUMMARY](../marketplace/MARKETPLACE_PHASE_1B_G_EXECUTIVE_SUMMARY.md) |
...
| Date | Change |
|------|--------|
| 2026-06-24 | **Marketplace Partner Runtime** (`marketplace_partner_runtime`) — **LEVEL 3 CERTIFIED WITH FINDINGS** executed (RD-MP-1B-G-001); **Platform Capability** (partner delegate foundation); Search + Workspace + Billing + Activity + Scope; pilot `vssyl-pilot-assets`; 0 blocking · 3 majors (F-01–F-03) · 5 advisories; Phase 1B-G governance — [MARKETPLACE_PARTNER_CAPABILITY_CERTIFICATION_RECORD](../marketplace/MARKETPLACE_PARTNER_CAPABILITY_CERTIFICATION_RECORD.md), [MARKETPLACE_PHASE_1B_G_EXECUTIVE_SUMMARY](../marketplace/MARKETPLACE_PHASE_1B_G_EXECUTIVE_SUMMARY.md), [PLATFORM_CAPABILITY_CATALOG](./PLATFORM_CAPABILITY_CATALOG.md) |
| 2026-06-23 | **Unified Search** (`unified_search`) — **LEVEL 2 CERTIFIED WITH FINDINGS** executed (RD-US-001); **Platform Capability** (federated discovery); Option C Hybrid; G1–G9 **21/27 (~78%)**; 9 providers; 0 blocking · 6 majors (SC-M1–M6) · 6 advisories; Phase 1B governance — [SEARCH_CAPABILITY_CERTIFICATION_REVIEW](../search/SEARCH_CAPABILITY_CERTIFICATION_REVIEW.md), [SEARCH_CONSTITUTION](../search/SEARCH_CONSTITUTION.md), [SEARCH_PHASE_1B_EXECUTIVE_SUMMARY](../search/SEARCH_PHASE_1B_EXECUTIVE_SUMMARY.md), [PLATFORM_CAPABILITY_CATALOG](./PLATFORM_CAPABILITY_CATALOG.md) |
| 2026-06-23 | **AI Retrieval Adapter** (`ai_retrieval`) — **LEVEL 2 CERTIFIED WITH FINDINGS** executed (RD-AR-001); **Platform Capability** (AI discovery orchestration); Option B Hybrid; G1–G9 **20/27 (~74%)**; 2 consumers; 0 blocking · 6 majors (AR-M1–M6) · 6 advisories; depends on `unified_search`; Phase 2A governance — [AI_RETRIEVAL_CAPABILITY_CERTIFICATION_REVIEW](../ai/retrieval/AI_RETRIEVAL_CAPABILITY_CERTIFICATION_REVIEW.md), [AI_RETRIEVAL_CONSTITUTION](../ai/retrieval/AI_RETRIEVAL_CONSTITUTION.md), [AI_RETRIEVAL_PHASE_2A_EXECUTIVE_SUMMARY](../ai/retrieval/AI_RETRIEVAL_PHASE_2A_EXECUTIVE_SUMMARY.md), [PLATFORM_CAPABILITY_CATALOG](./PLATFORM_CAPABILITY_CATALOG.md) |
| 2026-06-23 | **Context Graph** — **L4-F01 closed** (production soak gate); staging soak plan + results; production pilot **Approved With Findings** (staged cohort); 37/37 pilot tests — [CONTEXT_GRAPH_L4_F01_CLOSEOUT](../context-graph/CONTEXT_GRAPH_L4_F01_CLOSEOUT.md), [CONTEXT_GRAPH_PRODUCTION_PILOT_RECOMMENDATION](../context-graph/CONTEXT_GRAPH_PRODUCTION_PILOT_RECOMMENDATION.md) |
| 2026-06-23 | **Context Graph** — **LEVEL 4 CERTIFIED WITH FINDINGS** awarded (RD-CG-L4-001); consumption-unification amendment (1A–1C); **#CG-4** Reference Capability With Findings; G1–G9 **26/27 (~96%)**; 0 blocking · 1 major (L4-F01 production gate) · 7 advisories; L3 federation (RD-CG-010) reaffirmed — [CONTEXT_GRAPH_L4_CERTIFICATION_RECORD](../context-graph/CONTEXT_GRAPH_L4_CERTIFICATION_RECORD.md), [CONTEXT_GRAPH_L4_EXECUTIVE_SUMMARY](../context-graph/CONTEXT_GRAPH_L4_EXECUTIVE_SUMMARY.md) |
| 2026-06-23 | **Context Graph** — **L4 readiness review** (Phase 1D — superseded by L4 award above) — [CONTEXT_GRAPH_CERTIFICATION_READINESS_REVIEW](../context-graph/CONTEXT_GRAPH_CERTIFICATION_READINESS_REVIEW.md) |
| 2026-06-23 | **Platform Kernel** (`platform_kernel`) — **LEVEL 2 CERTIFIED WITH FINDINGS** executed (RD-PK-001); **Platform Capability** composite (Activity + Domain Events); Topology Option C; G1–G9 **21/27 (~78%)**; sub-scores Activity **22/27**, Domain Events **21/27**; 0 blocking · 4 majors · 6 advisories; Domain Event Bus + Module Activity platform rows elevated to L2 CwF sub-scores; program **ARCHIVED** — [PLATFORM_KERNEL_CERTIFICATION_RECORD](../platform-kernel/PLATFORM_KERNEL_CERTIFICATION_RECORD.md), [PLATFORM_KERNEL_GOVERNANCE_EXECUTION](../platform-kernel/PLATFORM_KERNEL_GOVERNANCE_EXECUTION.md), [PLATFORM_KERNEL_PROGRAM_ARCHIVE](../platform-kernel/PLATFORM_KERNEL_PROGRAM_ARCHIVE.md) |
