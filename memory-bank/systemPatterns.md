...
| Module AI context | Every module ships real `ModuleAIContext` + bounded authenticated context providers | [`aiContextSystem.md`](./aiContextSystem.md); [`AI_CONTEXT_PROVIDER_API.md`](../docs/guides/AI_CONTEXT_PROVIDER_API.md) | Context providers; registry |
