...
## Archived HR framework docs (April 2026)

Standalone HR markdown files (`HR_MODULE_*`, `HR_FRAMEWORK_*`, deployment status, analytics/notifications completion notes) were moved to **`docs/archive/hr-merged-2026/`** so this file stays the single product source of truth. Use the archive only for historical line counts and dated completion summaries.
