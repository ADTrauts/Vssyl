          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <label className="text-sm font-medium text-v-text-secondary">Equipment Items</label>
              ...
              {items.length === 0 ? (
                <div className="text-center py-8 text-v-text-muted border border-dashed rounded-lg">
                  <Package className="w-8 h-8 mx-auto mb-2 text-v-text-muted" />
                  <p className="text-sm">No equipment items added yet</p>
                  <p className="text-xs text-v-text-muted mt-1">Click "Add Item" to get started</p>
                </div>
              ) : (
                <div className="space-y-3">
                  {items.map((item, index) => (
                    <Card key={index} className="p-4">
                      <div className="flex items-start justify-between mb-3">
                        <h4 className="text-sm font-medium text-v-text-primary">Item {index + 1}</h4>
                        <Button
                          variant="ghost"
                          size="sm"
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        <div>
                          ...
                          <input
                            ...
                            className="w-full rounded-md border border-v-border px-3 py-2 text-sm text-v-text-primary focus:outline-none focus:ring-2 focus:ring-blue-500"
