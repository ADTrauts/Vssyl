  ...
  if (!analytics) {
    return (
      <div className="text-center py-16 px-4">
        ...
        <p className="text-sm text-gray-600 mt-1">Start using your Main Street and analytics will appear.</p>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <h2 className="text-lg font-bold text-gray-900">Your Place Analytics</h2>
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
        <Card>
          <div className="p-3 text-center">
            ...
            <p className="text-xl font-bold text-gray-900">{analytics.network.totalNodes}</p>
        ...
        <Card>
          <div className="p-3 text-center">
            ...
            <p className="text-xl font-bold text-gray-900">{analytics.network.businessNodes}</p>
        ...
        <Card>
          <div className="p-3 text-center">
            ...
            <p className="text-xl font-bold text-gray-900">{analytics.network.userConnections}</p>
        ...
        <Card>
          <div className="p-3 text-center">
            ...
            <p className="text-xl font-bold text-gray-900">{analytics.engagement.meetingsCreated + analytics.engagement.meetingsAttended}</p>
        ...
        <Card>
          <div className="p-3 text-center">
            ...
            <p className="text-xl font-bold text-gray-900">{analytics.network.communitiesJoined}</p>
        ...
        <Card>
          <div className="p-4">
            <div className="flex items-center gap-2 mb-3">
              ...
              <h3 className="text-sm font-semibold text-gray-900">Spending</h3>
            </div>
            <div className="grid grid-cols-3 gap-3 text-center">
              <div>
                <p className="text-lg font-bold text-gray-900">${analytics.spending.totalSpent.toFixed(2)}</p>
                <p className="text-xs text-gray-600">Total Spent</p>
              </div>
              <div>
                <p className="text-lg font-bold text-gray-900">{analytics.spending.purchaseCount}</p>
                <p className="text-xs text-gray-600">Purchases</p>
              </div>
              <div>
                <p className="text-lg font-bold text-gray-900">{analytics.spending.externalClicks}</p>
              ...
              <div className="mt-3 pt-3 border-t border-gray-100">
                ...
                <div className="flex flex-wrap gap-1.5">
                  {analytics.spending.topCategories.map(c => (
                    <span key={c.category} className="text-xs px-2 py-1 bg-gray-50 text-gray-700 rounded-full border border-gray-200">
        ...
        <Card>
          <div className="p-4">
            <div className="flex items-center gap-2 mb-3">
              ...
              <h3 className="text-sm font-semibold text-gray-900">Network Growth (4 weeks)</h3>
            </div>
        ...
        <Card>
          <div className="p-4">
            <div className="flex items-center gap-2 mb-3">
              ...
              <h3 className="text-sm font-semibold text-gray-900">Most Interacted Businesses</h3>
            </div>
              ...
              {analytics.topBusinesses.map((biz, i) => (
                <div key={biz.businessId} className="flex items-center gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-gray-600">{biz.category.toLowerCase().replace('_', ' ')}</p>
                  </div>
                  <span className="text-sm font-semibold text-gray-900">{biz.interactions}x</span>
                </div>
              ))}
            </div>
          </div>
