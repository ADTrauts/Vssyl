    ...
    <div className="space-y-3">
      ...
      {isHouseholdContext && safeConfig.showSharedFolders && (
        <div className="mb-4 p-3 bg-orange-50 dark:bg-orange-950/30 rounded-lg border border-orange-200 dark:border-orange-900/50">
          <div className="flex items-center justify-between mb-2">
            <div className="flex items-center space-x-2">
              <Folder className="w-4 h-4 text-orange-600 dark:text-orange-300" />
              <h4 className="text-sm font-medium text-orange-800 dark:text-orange-200">Family Shared Folders</h4>
            </div>
            <Button
              size="sm"
              variant="ghost"
          ...
          <div className="space-y-2">
            <div className="flex items-center space-x-3 p-2 hover:bg-orange-100 dark:hover:bg-orange-900/40 rounded cursor-pointer">
              <Folder className="w-4 h-4 text-orange-600 dark:text-orange-300" />
              <div className="flex-1 min-w-0">
                <p className="text-sm font-medium text-orange-900 dark:text-orange-100">📸 Family Photos</p>
                <p className="text-xs text-orange-700 dark:text-orange-300">Shared with all family members</p>
              </div>
            </div>
            <div className="flex items-center space-x-3 p-2 hover:bg-orange-100 dark:hover:bg-orange-900/40 rounded cursor-pointer">
              <Folder className="w-4 h-4 text-orange-600 dark:text-orange-300" />
              <div className="flex-1 min-w-0">
                <p className="text-sm font-medium text-orange-900 dark:text-orange-100">📄 Important Documents</p>
                <p className="text-xs text-orange-700 dark:text-orange-300">Access for adults only</p>
              </div>
            </div>
            <div className="flex items-center space-x-3 p-2 hover:bg-orange-100 dark:hover:bg-orange-900/40 rounded cursor-pointer">
              <Folder className="w-4 h-4 text-orange-600 dark:text-orange-300" />
              <div className="flex-1 min-w-0">
                <p className="text-sm font-medium text-orange-900 dark:text-orange-100">🎓 School & Activities</p>
                <p className="text-xs text-orange-700 dark:text-orange-300">Kids and parents</p>
              </div>
            </div>
          </div>
        </div>
      ...
      {isHouseholdContext && safeConfig.showFamilyActivity && (
        <div className="mb-4 p-3 bg-green-50 dark:bg-emerald-950/30 rounded-lg border border-green-200 dark:border-emerald-900/50">
          <div className="flex items-center space-x-2 mb-2">
            <Clock className="w-4 h-4 text-green-600 dark:text-emerald-300" />
            <h4 className="text-sm font-medium text-green-800 dark:text-emerald-200">Recent Family Activity</h4>
          </div>
          <div className="space-y-2 text-xs">
            <div className="flex items-center justify-between py-1">
              <span className="text-green-900 dark:text-emerald-100">Mom uploaded vacation-photos.zip</span>
              <span className="text-green-700 dark:text-emerald-300">2m ago</span>
            </div>
            <div className="flex items-center justify-between py-1">
              <span className="text-green-900 dark:text-emerald-100">Dad shared homework-folder</span>
              <span className="text-green-700 dark:text-emerald-300">1h ago</span>
            </div>
            <div className="flex items-center justify-between py-1">
              <span className="text-green-900 dark:text-emerald-100">Emma created art-projects folder</span>
              <span className="text-green-700 dark:text-emerald-300">3h ago</span>
            </div>
          </div>
        </div>
      )}
      ...
      {safeConfig.showRecentFiles && (recentFiles.length > 0 || recentFolders.length > 0) && (
        <div>
          <div className="flex items-center justify-between mb-2">
            <h4 className="text-sm font-medium text-gray-700 dark:text-gray-300">Recent Files</h4>
          ...
          <div className="space-y-2">
            {recentFiles.length === 0 ? (
              <p className="text-sm text-gray-600 dark:text-gray-400 py-2">No files yet</p>
            ) : (
              recentFiles.map((file) => (
              <div
                key={file.id}
                className="flex items-center space-x-3 p-2 bg-gray-50 dark:bg-slate-900 hover:bg-gray-100 dark:hover:bg-slate-800 rounded-lg cursor-pointer"
      ...
      {recentFolders.length > 0 && (
        <div className="mb-4">
          <div className="flex items-center justify-between mb-2">
            <h4 className="text-sm font-medium text-gray-700 dark:text-gray-300">Recent Folders</h4>
          </div>
          <div className="space-y-2">
      ...
      {onConfigChange && (
        <div className="pt-2 border-t border-gray-100 dark:border-slate-700">
          <button
            ...
            className="flex items-center gap-1.5 text-xs text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100"
          >
          ...
          <div className="space-y-2">
            <label className="flex items-center space-x-2">
              <input
                ...
                className="rounded"
              />
              <span className="text-sm text-gray-600 dark:text-gray-400">Show recent files</span>
            </label>
            <label className="flex items-center space-x-2">
              <input
                type="checkbox"
                ...
                className="rounded"
              />
              <span className="text-sm text-gray-600 dark:text-gray-400">Show storage usage</span>
            </label>
            <label className="flex items-center space-x-2">
              <input
                type="checkbox"
                ...
                className="rounded"
              />
              <span className="text-sm text-gray-600 dark:text-gray-400">Show upload button</span>
            </label>
            <div className="flex items-center space-x-2">
              <span className="text-sm text-gray-600 dark:text-gray-400">Max files to show:</span>
              <select
            ...
            {isHouseholdContext && (
              <>
                <div className="border-t border-gray-200 dark:border-slate-700 my-3 pt-3">
                  <h6 className="text-xs font-medium text-orange-700 dark:text-orange-300 mb-2 uppercase tracking-wider">
                    🏠 Family Settings
                  </h6>
                </div>
                <label className="flex items-center space-x-2">
                  <input
                    ...
                    className="rounded"
                  />
                  <span className="text-sm text-gray-600 dark:text-gray-400">Show household files</span>
                </label>
                <label className="flex items-center space-x-2">
                  <input
                    type="checkbox"
                    ...
                    className="rounded"
                  />
                  <span className="text-sm text-gray-600 dark:text-gray-400">Show shared folders</span>
                </label>
                <label className="flex items-center space-x-2">
                  <input
                    type="checkbox"
                    ...
                    className="rounded"
                  />
                  <span className="text-sm text-gray-600 dark:text-gray-400">Show family activity</span>
                </label>
              </>
            )}
          </div>
