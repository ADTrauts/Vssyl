...
export default function NotificationsWidget({
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center py-8">
        <Spinner size={24} />
        <span className="ml-2 text-gray-600 dark:text-gray-400 text-sm">Loading notifications...</span>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-3">
            ...
            return (
              <div
                ...
                className={`flex items-start gap-3 p-2.5 rounded-lg border transition-colors ${
                  notification.read
                    ? 'border-gray-100 dark:border-slate-700 bg-gray-50/50 dark:bg-slate-900'
                    : 'border-blue-200 dark:border-blue-900/60 bg-blue-50/30 dark:bg-blue-950/30'
                }`}
              >
                ...
                <div className="flex-1 min-w-0">
                  <p className={`text-sm ${notification.read ? 'text-gray-700 dark:text-gray-300' : 'text-gray-900 dark:text-gray-100 font-medium'}`}>
                    {notification.title}
                  </p>
                  <p className="text-xs text-gray-600 dark:text-gray-400 truncate">{notification.body}</p>
                ...
                {!notification.read && (
                  <button
                    ...
                    className="p-1 rounded hover:bg-gray-200 text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 flex-shrink-0"
                    title="Mark as read"
                  >
      ...
      {/* Settings toggle */}
      <div className="flex justify-end border-t border-gray-100 dark:border-slate-700 pt-2">
        <button
        ...
        <div className="p-3 bg-gray-50 dark:bg-slate-800 rounded-lg space-y-2">
          <div className="flex items-center gap-2 text-sm text-gray-700 dark:text-gray-300">
            ...
            <select
              ...
              className="text-sm border border-gray-300 dark:border-slate-600 rounded px-2 py-1 bg-white dark:bg-slate-900 text-gray-900 dark:text-gray-100"
            >
