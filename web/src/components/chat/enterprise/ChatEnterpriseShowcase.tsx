    ...
    <div className="space-y-6">
      ...
      <div className="text-center py-8">
        <div className="flex items-center justify-center gap-3 mb-4">
          ...
          <div>
            <h2 className="text-3xl font-bold text-gray-900 dark:text-gray-100">Enterprise Chat Features</h2>
        ...
        <div className="flex items-center justify-center gap-2 mb-6">
          ...
          <span className="text-sm text-gray-600 dark:text-gray-400">Starting at $15/user/month</span>
          <span className="text-gray-600 dark:text-gray-400">•</span>
        ...
        <div className="text-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-8">
            <div className="text-center">
              ...
              <div className="text-sm text-gray-600 dark:text-gray-400">AES Encryption</div>
            </div>
            <div className="text-center">
              <div className="flex items-center justify-center gap-1 mb-2">
              ...
              <div className="text-sm text-gray-600 dark:text-gray-400">Type II Certified</div>
            </div>
            <div className="text-center">
              <div className="flex items-center justify-center gap-1 mb-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="p-6">
          <div className="text-center">
            ...
            <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">Executive Communications</h3>
        ...
        <Card className="p-6">
          <div className="text-center">
            ...
            <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">Legal & Compliance</h3>
            <p className="text-sm text-gray-600 dark:text-gray-400">
        ...
        <Card className="p-6">
          <div className="text-center">
            ...
            <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">HR & People Operations</h3>
            <p className="text-sm text-gray-600 dark:text-gray-400">
