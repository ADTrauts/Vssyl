    ...
    return (
      <Card className={`p-6 ${className}`}>
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400">Loading retention policies...</p>
        </div>
      </Card>
    );
  }
      ...
      <Card className={`${className}`}>
        ...
        <div className="p-6 border-b border-gray-200 dark:border-slate-700">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100">Message Retention & Compliance</h2>
                <p className="text-gray-600 dark:text-gray-400">Manage data retention policies and legal holds</p>
              </div>
            </div>
        ...
        <div className="p-6">
            ...
            <div className="space-y-4">
              {retentionPolicies.map(policy => (
                <Card key={policy.id} className="p-4 border border-gray-200 dark:border-slate-700">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 text-sm mb-3">{policy.description}</p>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                    ...
                    <div>
                      <div className="text-gray-500 dark:text-gray-400 mb-1">User Groups</div>
                      <div className="text-gray-900 dark:text-gray-100">{policy.userGroups.length} groups</div>
                    </div>
                    <div>
                      <div className="text-gray-500 dark:text-gray-400 mb-1">Auto Delete</div>
                      <div className="text-gray-900 dark:text-gray-100">{policy.autoDelete ? 'Yes' : 'No'}</div>
                    </div>
                    <div>
                      <div className="text-gray-500 dark:text-gray-400 mb-1">Compliance</div>
                      <div className="flex gap-1">
                        {policy.complianceRules.map(rule => (
                          <Badge key={rule} className="px-1 py-0.5 text-xs bg-gray-100 dark:bg-slate-700 text-gray-700 dark:text-gray-300 rounded">
                            {rule}
                          </Badge>
                        ))}
                      </div>
          ...
          {activeTab === 'archives' && (
            <div className="space-y-4">
              {messageArchives.map(archive => (
                <Card key={archive.id} className="p-4 border border-gray-200 dark:border-slate-700">
                  <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center gap-3">
                      <FileText className="w-5 h-5 text-gray-400" />
                      <h3 className="font-medium text-gray-900 dark:text-gray-100">{archive.conversationName}</h3>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-5 gap-4 text-sm">
                    <div>
                      ...
                      <div className="text-gray-900 dark:text-gray-100">{archive.messageCount.toLocaleString()}</div>
                    </div>
                    <div>
                      <div className="text-gray-500 dark:text-gray-400 mb-1">Size</div>
                      <div className="text-gray-900 dark:text-gray-100">{formatBytes(archive.size)}</div>
                    </div>
                    <div>
                      <div className="text-gray-500 dark:text-gray-400 mb-1">Date Range</div>
                      <div className="text-gray-900 dark:text-gray-100">
                        {archive.dateRange.start.toLocaleDateString()} - {archive.dateRange.end.toLocaleDateString()}
                      </div>
                    </div>
                    <div>
                      <div className="text-gray-500 dark:text-gray-400 mb-1">Policy</div>
                      <div className="text-gray-900 dark:text-gray-100">{archive.retentionPolicy}</div>
                    </div>
                    <div>
                      <div className="text-gray-500 dark:text-gray-400 mb-1">Compliance</div>
                      <div className="flex gap-1">
          ...
          {activeTab === 'legal_holds' && (
            <div className="space-y-4">
              {legalHolds.map(hold => (
                <Card key={hold.id} className="p-4 border border-gray-200 dark:border-slate-700">
                  <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center gap-3">
                      <Shield className="w-5 h-5 text-purple-600" />
                      <h3 className="font-medium text-gray-900 dark:text-gray-100">{hold.name}</h3>
                  ...
                  <p className="text-gray-600 dark:text-gray-400 text-sm mb-3">{hold.description}</p>
                  
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                    <div>
                      <div className="text-gray-500 dark:text-gray-400 mb-1">Conversations</div>
                      <div className="text-gray-900 dark:text-gray-100">{hold.conversations.length} conversations</div>
                    </div>
                    <div>
                      <div className="text-gray-500 dark:text-gray-400 mb-1">Custodians</div>
                      <div className="text-gray-900 dark:text-gray-100">{hold.custodians.length} custodians</div>
                    </div>
                    <div>
                      <div className="text-gray-500 dark:text-gray-400 mb-1">Case Number</div>
                      <div className="text-gray-900 dark:text-gray-100">{hold.caseNumber || 'N/A'}</div>
                    </div>
                    <div>
                      <div className="text-gray-500 dark:text-gray-400 mb-1">Start Date</div>
                      <div className="text-gray-900 dark:text-gray-100">{hold.startDate.toLocaleDateString()}</div>
                    </div>
                  </div>
                </Card>
              ))}
