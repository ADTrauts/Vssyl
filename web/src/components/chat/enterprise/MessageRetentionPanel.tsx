  ...
  const loadRetentionData = async () => {
    try {
      ...
      const mockPolicies: RetentionPolicy[] = [
        {
          id: '1',
          name: 'Standard Business Communications',
          description: 'Default retention policy for regular business communications',
          retentionPeriod: 1095, // 3 years
          channels: ['general', 'marketing-team', 'sales'],
        ...
        },
        {
          ...
          description: 'Extended retention for executive and board communications',
          retentionPeriod: 2555, // 7 years
          channels: ['executive', 'board-meetings'],
          userGroups: ['executives', 'board-members'],
          messageTypes: ['text', 'file', 'voice'],
          autoDelete: false,
          legalHold: true,
          complianceRules: ['SOX', 'SEC'],
          enabled: true,
        ...
        },
        {
          ...
          description: 'Customer communication retention for service quality',
          retentionPeriod: 365, // 1 year
          channels: ['customer-support'],
          userGroups: ['support-team'],
          messageTypes: ['text', 'file'],
          autoDelete: true,
          legalHold: false,
      ...
      const mockArchives: MessageArchive[] = [
        {
          id: '1',
          conversationId: 'conv_1',
          conversationName: 'Q4 Planning Discussion',
          messageCount: 245,
          dateRange: {
          ...
          size: 15728640, // 15MB
          retentionPolicy: 'Standard Business Communications',
          status: 'archived',
          complianceFlags: ['GDPR', 'SOX'],
          downloadUrl: '/api/archives/download/1',
          createdAt: new Date(Date.now() - 90 * 24 * 60 * 60 * 1000)
        },
        {
          id: '2',
          conversationId: 'conv_2',
          conversationName: 'Legal Review - Acquisition',
          messageCount: 89,
          dateRange: {
          ...
          size: 8388608, // 8MB
          retentionPolicy: 'Executive Communications',
          status: 'legal_hold',
      ...
      const mockHolds: LegalHold[] = [
        {
          id: '1',
          name: 'Project Alpha Litigation',
          description: 'Legal hold for Project Alpha intellectual property dispute',
          conversations: ['conv_2', 'conv_5', 'conv_8'],
          startDate: new Date(Date.now() - 60 * 24 * 60 * 60 * 1000),
          custodians: ['john.doe@company.com', 'jane.smith@company.com'],
          status: 'active',
          complianceOfficer: 'legal@company.com',
        ...
        },
        {
          ...
          description: 'Regulatory investigation into Q3 earnings',
          conversations: ['conv_3', 'conv_4'],
          startDate: new Date(Date.now() - 30 * 24 * 60 * 60 * 1000),
          endDate: new Date(Date.now() + 30 * 24 * 60 * 60 * 1000),
          custodians: ['cfo@company.com', 'controller@company.com'],
          status: 'active',
          complianceOfficer: 'compliance@company.com',
          caseNumber: 'SEC-2024-008'
        }
      ];
