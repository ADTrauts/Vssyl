    ...
    return (
      <div className="flex items-center justify-center h-full">
        <div className="text-center">
          <p className="text-v-text-secondary">Loading team schedules...</p>
        </div>
      </div>
    );
  }
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-3 mb-6">
          <Card className="p-4 hover:shadow-md transition-shadow">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-xs font-medium text-v-text-muted uppercase tracking-wide mb-1">Team Schedules</p>
                <p className="text-2xl font-semibold text-v-text-primary">{schedules.length}</p>
              </div>
          ...
          <Card className="p-4 hover:shadow-md transition-shadow">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-xs font-medium text-v-text-muted uppercase tracking-wide mb-1">Scheduled This Week</p>
                <p className="text-2xl font-semibold text-v-text-primary">{uniqueEmployees.size}</p>
              </div>
              <div className="flex-shrink-0">
          ...
          <Card className="p-4 hover:shadow-md transition-shadow">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-semibold text-v-text-primary">{openShiftsThisWeek}</p>
              </div>
              <div className="flex-shrink-0">
          ...
          <Card className="p-4 hover:shadow-md transition-shadow">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-semibold text-v-text-primary">{pendingSwaps.length}</p>
              </div>
              <div className="flex-shrink-0">
        ...
        <Card className="mb-6">
          <div className="p-6">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-xl font-semibold text-v-text-primary">Team Schedule</h2>
        ...
        <div className="space-y-4">
          {pendingSwaps.length === 0 ? (
            <Card className="p-6 text-center">
              <CheckCircle2 className="h-12 w-12 text-v-text-muted mx-auto mb-4" />
              <p className="text-v-text-secondary">No pending swap requests</p>
            </Card>
          ) : (
