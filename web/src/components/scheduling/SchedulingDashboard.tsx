...
export default function SchedulingDashboard({
  ...
  return (
    <div className="h-full overflow-y-auto p-6">
      {/* Header */}
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-v-text-primary">Scheduling Dashboard</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 mb-6">
          ...
          <>
            <Card className="p-4 hover:shadow-md transition-shadow">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs font-medium text-v-text-muted uppercase tracking-wide mb-1">Total Schedules</p>
                  <p className="text-2xl font-semibold text-v-text-primary">{totalSchedules}</p>
                </div>
            ...
            <Card className="p-4 hover:shadow-md transition-shadow">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs font-medium text-v-text-muted uppercase tracking-wide mb-1">Published</p>
                  <p className="text-2xl font-semibold text-v-text-primary">{publishedSchedules}</p>
                </div>
                <div className="flex-shrink-0">
            ...
            <Card className="p-4 hover:shadow-md transition-shadow">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs font-medium text-v-text-muted uppercase tracking-wide mb-1">Draft</p>
                  <p className="text-2xl font-semibold text-v-text-primary">{draftSchedules}</p>
                </div>
                <div className="flex-shrink-0">
        ...
        {(isAdmin || isManager) && (
          <Card className="p-4 hover:shadow-md transition-shadow">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-xs font-medium text-v-text-muted uppercase tracking-wide mb-1">Pending Swaps</p>
                <p className="text-2xl font-semibold text-v-text-primary">{pendingSwaps}</p>
              </div>
              <div className="flex-shrink-0">
        ...
        <Card className="p-4 hover:shadow-md transition-shadow">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-semibold text-v-text-primary">{openShifts}</p>
            </div>
            <div className="flex-shrink-0">
      ...
      <Card className="mb-6">
        <div className="p-6">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-xl font-semibold text-v-text-primary">Current Schedule</h2>
