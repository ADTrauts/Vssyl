  ...
  return (
    <div className={`bg-white dark:bg-slate-900 rounded-lg shadow-sm border border-gray-200 dark:border-slate-700 ${className}`}>
      <div className="p-6 border-b border-gray-200 dark:border-slate-700">
        <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">User Context Inspector</h3>
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="bg-gray-50 dark:bg-slate-800 rounded-lg p-4">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h4 className="font-semibold text-gray-900 dark:text-gray-100">User Information</h4>
            </div>
            <div className="grid grid-cols-2 gap-4 text-sm">
              ...
              <div>
                <span className="text-gray-700 dark:text-gray-300">User Number:</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-blue-50 rounded-lg p-4">
              <div className="flex items-center gap-3 mb-2">
                ...
                <h4 className="font-semibold text-gray-900 dark:text-gray-100">AI Personality Profile</h4>
              </div>
            ...
            <div className="bg-purple-50 rounded-lg p-4">
              <div className="flex items-center gap-3 mb-2">
                ...
                <h4 className="font-semibold text-gray-900 dark:text-gray-100">AI Autonomy Settings</h4>
              </div>
              <div className="text-sm">
                <p className="text-gray-700 dark:text-gray-300">
          ...
          <div className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-700 rounded-lg p-4">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h4 className="font-semibold text-gray-900 dark:text-gray-100">Recent AI Conversations</h4>
              <span className="text-sm text-gray-700 dark:text-gray-300 dark:text-gray-400">({selectedUser.recentConversations.length} recent)</span>
            </div>
            ...
            {selectedUser.recentConversations.length > 0 ? (
              <div className="space-y-3">
                {selectedUser.recentConversations.slice(0, 5).map((conversation) => (
                  <div key={conversation.id} className="border border-gray-100 rounded-lg p-3">
                    ...
                    <div className="flex justify-between items-center text-xs text-gray-700 dark:text-gray-300 dark:text-gray-400">
              ...
              <p className="text-gray-700 dark:text-gray-300 dark:text-gray-400 text-sm">No recent conversations found</p>
            )}
          </div>
          ...
          <div className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-700 rounded-lg p-4">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h4 className="font-semibold text-gray-900 dark:text-gray-100">Installed Modules</h4>
              <span className="text-sm text-gray-700 dark:text-gray-300 dark:text-gray-400">({selectedUser.moduleInstallations.length})</span>
            </div>
            
            {selectedUser.moduleInstallations.length > 0 ? (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                {selectedUser.moduleInstallations.map((installation) => (
                  <div key={installation.id} className="flex items-center gap-2 p-2 bg-gray-50 dark:bg-slate-800 rounded">
                    <Package className="w-4 h-4 text-gray-700 dark:text-gray-300 dark:text-gray-400" />
                    <div>
                      <p className="text-sm font-medium text-gray-900 dark:text-gray-100">{installation.module.name}</p>
                      <p className="text-xs text-gray-700 dark:text-gray-300 dark:text-gray-400">{installation.module.category}</p>
                    </div>
                  </div>
                ))}
              </div>
            ) : (
              <p className="text-gray-700 dark:text-gray-300 dark:text-gray-400 text-sm">No modules installed</p>
            )}
          </div>
          ...
          <div className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-700 rounded-lg p-4">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h4 className="font-semibold text-gray-900 dark:text-gray-100">Business Memberships</h4>
              <span className="text-sm text-gray-700 dark:text-gray-300 dark:text-gray-400">({selectedUser.businessMemberships.length})</span>
            </div>
            
            {selectedUser.businessMemberships.length > 0 ? (
              <div className="space-y-2">
                {selectedUser.businessMemberships.map((membership) => (
                  <div key={membership.id} className="flex items-center gap-2 p-2 bg-gray-50 dark:bg-slate-800 rounded">
                    <Building className="w-4 h-4 text-gray-700 dark:text-gray-300 dark:text-gray-400" />
                    <div>
                      <p className="text-sm font-medium text-gray-900 dark:text-gray-100">{membership.business.name}</p>
                      <p className="text-xs text-gray-700 dark:text-gray-300 dark:text-gray-400">{membership.business.industry || 'No industry specified'}</p>
                    </div>
                  </div>
                ))}
              </div>
            ) : (
              <p className="text-gray-700 dark:text-gray-300 dark:text-gray-400 text-sm">No business memberships</p>
            )}
          </div>
          ...
          <div className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-700 rounded-lg p-4">
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-sm text-gray-700 dark:text-gray-300 dark:text-gray-400">({selectedUser.recentActivity.length} recent)</span>
            </div>
            
            {selectedUser.recentActivity.length > 0 ? (
              <div className="space-y-2">
                {selectedUser.recentActivity.slice(0, 5).map((activity) => (
                  <div key={activity.id} className="flex items-center gap-3 p-2 bg-gray-50 dark:bg-slate-800 rounded">
                    <Activity className="w-4 h-4 text-gray-700 dark:text-gray-300 dark:text-gray-400" />
                    <div className="flex-1">
                      <p className="text-sm font-medium text-gray-900 dark:text-gray-100">{activity.type}</p>
                      <p className="text-xs text-gray-700 dark:text-gray-300 dark:text-gray-400">{formatDate(activity.timestamp)}</p>
                    </div>
                  </div>
                ))}
              </div>
            ) : (
              <p className="text-gray-700 dark:text-gray-300 dark:text-gray-400 text-sm">No recent activity found</p>
            )}
          </div>
        </div>
      )}
