  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Scope and Business Selection */}
        <div className="bg-white rounded-lg shadow-sm border p-6 mb-6">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-lg font-semibold text-gray-900">Module Scope</h2>
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-2">
                <button
                  onClick={() => setScope('personal')}
          ...
          {scope === 'business' && businessId && businessFeatures && (
            <div className="mt-4 p-4 bg-purple-50 rounded-lg border border-purple-200">
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-sm font-medium text-purple-900">Business Subscription</h3>
                  <p className="text-xs text-purple-700">
                    {businessFeatures.subscriptionTier === 'enterprise' ? 'Enterprise Plan' : 
                     businessFeatures.subscriptionTier === 'standard' ? 'Standard Plan' : 'Free Plan'}
                  </p>
                </div>
                <div className="text-right">
                  <p className="text-xs text-purple-700">
                    Module Limit: {businessFeatures.moduleLimit || 'Unlimited'}
                  </p>
                  <p className="text-xs text-purple-700">
                    Installed: {businessFeatures.installedModules || 0}
                  </p>
                </div>
              </div>
              
              {/* Enterprise Features */}
              {businessFeatures.subscriptionTier === 'enterprise' && (
                <div className="mt-3 pt-3 border-t border-purple-200">
                  <div className="flex items-center justify-between text-xs">
                    <span className="text-purple-700">Advanced Permissions</span>
                    <span className="text-green-600 font-medium">✓ Enabled</span>
                  </div>
                  <div className="flex items-center justify-between text-xs mt-1">
                    <span className="text-purple-700">Team Management</span>
                    <span className="text-green-600 font-medium">✓ Enabled</span>
                  </div>
                  <div className="flex items-center justify-between text-xs mt-1">
                    <span className="text-purple-700">Audit Logs</span>
                    <span className="text-green-600 font-medium">✓ Enabled</span>
                  </div>
                </div>
              )}
