      ...
      <section id="features" className="py-20 bg-white dark:bg-slate-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white dark:bg-slate-900 p-6 rounded-lg shadow-lg border border-gray-200 dark:border-slate-700 hover:shadow-xl transition-shadow">
              <div className="flex items-center mb-4">
                <Brain className="h-8 w-8 mr-3" style={{ color: COLORS.infoBlue }} />
                <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100">AI Digital Life Twin</h3>
              </div>
            ...
            <div className="bg-white dark:bg-slate-900 p-6 rounded-lg shadow-lg border border-gray-200 dark:border-slate-700 hover:shadow-xl transition-shadow">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100">Modular Platform</h3>
              </div>
              <p className="text-gray-600 dark:text-gray-400 mb-4">
            ...
            <div className="bg-white dark:bg-slate-900 p-6 rounded-lg shadow-lg border border-gray-200 dark:border-slate-700 hover:shadow-xl transition-shadow">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100">Advanced Analytics</h3>
              </div>
              <p className="text-gray-600 dark:text-gray-400 mb-4">
            ...
            <div className="bg-white dark:bg-slate-900 p-6 rounded-lg shadow-lg border border-gray-200 dark:border-slate-700 hover:shadow-xl transition-shadow">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100">Enterprise Security</h3>
              </div>
              <p className="text-gray-600 dark:text-gray-400 mb-4">
            ...
            <div className="bg-white dark:bg-slate-900 p-6 rounded-lg shadow-lg border border-gray-200 dark:border-slate-700 hover:shadow-xl transition-shadow">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100">Global Platform</h3>
              </div>
              <p className="text-gray-600 dark:text-gray-400 mb-4">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white dark:bg-slate-900 p-6 rounded-lg shadow-md text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">Chat & Messaging</h3>
              <p className="text-gray-600 dark:text-gray-400 text-sm">Real-time communication with file sharing and reactions</p>
            </div>

            <div className="bg-white dark:bg-slate-900 p-6 rounded-lg shadow-md text-center">
              <FolderOpen className="h-12 w-12 mx-auto mb-4" style={{ color: COLORS.infoBlue }} />
              <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">Drive & Files</h3>
              <p className="text-gray-600 dark:text-gray-400 text-sm">Secure file storage with advanced sharing and collaboration</p>
            </div>

            <div className="bg-white dark:bg-slate-900 p-6 rounded-lg shadow-md text-center">
              <Calendar className="h-12 w-12 mx-auto mb-4" style={{ color: COLORS.infoBlue }} />
              <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">Calendar & Scheduling</h3>
              <p className="text-gray-600 dark:text-gray-400 text-sm">Smart scheduling with AI-powered optimization</p>
            </div>
            ...
            <div className="bg-white dark:bg-slate-900 p-6 rounded-lg shadow-md text-center">
              ...
              <p className="text-gray-600 dark:text-gray-400 text-sm">Intelligent automation and personalized recommendations</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-white dark:bg-slate-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Free Plan */}
            <div className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-700 rounded-lg p-8 shadow-md">
              <div className="text-center">
                ...
                <p className="text-gray-600 dark:text-gray-400 mb-6">Perfect for individuals getting started</p>
              </div>
              <ul className="space-y-3 mb-8">
                <li className="flex items-center">
                  <CheckCircle className="h-5 w-5 mr-3 text-green-500" />
                  <span className="text-gray-600 dark:text-gray-400">Basic AI assistant</span>
                </li>
                <li className="flex items-center">
                  <CheckCircle className="h-5 w-5 mr-3 text-green-500" />
                  <span className="text-gray-600 dark:text-gray-400">Core modules included</span>
                </li>
                <li className="flex items-center">
                  <CheckCircle className="h-5 w-5 mr-3 text-green-500" />
                  <span className="text-gray-600 dark:text-gray-400">5GB storage</span>
                </li>
                <li className="flex items-center">
                  <CheckCircle className="h-5 w-5 mr-3 text-green-500" />
              ...
              <Link
                href="/auth/register"
                className="w-full block text-center py-3 px-4 border border-gray-300 dark:border-slate-600 rounded-md text-gray-700 dark:text-gray-300 bg-white dark:bg-slate-900 hover:bg-gray-50 dark:hover:bg-slate-800 dark:bg-slate-800 transition-colors"
              >
                Get Started Free
              </Link>
            </div>
            ...
            {/* Pro Plan */}
            <div className="bg-white dark:bg-slate-900 border-2 rounded-lg p-8 shadow-lg relative" style={{ borderColor: COLORS.infoBlue }}>
              ...
              <ul className="space-y-3 mb-8">
                <li className="flex items-center">
                  <CheckCircle className="h-5 w-5 mr-3 text-green-500" />
                  <span className="text-gray-600 dark:text-gray-400">Advanced AI features</span>
                </li>
                <li className="flex items-center">
                  <CheckCircle className="h-5 w-5 mr-3 text-green-500" />
                  <span className="text-gray-600 dark:text-gray-400">All core modules + premium</span>
                </li>
                <li className="flex items-center">
                  <CheckCircle className="h-5 w-5 mr-3 text-green-500" />
            ...
            <div className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-700 rounded-lg p-8 shadow-md">
              <div className="text-center">
                ...
                <div className="text-4xl font-bold text-gray-900 dark:text-gray-100 mb-4">
                  Custom<span className="text-lg font-normal text-gray-600 dark:text-gray-400"></span>
                </div>
              ...
              <ul className="space-y-3 mb-8">
                <li className="flex items-center">
                  <CheckCircle className="h-5 w-5 mr-3 text-green-500" />
                  <span className="text-gray-600 dark:text-gray-400">Full AI capabilities</span>
                </li>
                <li className="flex items-center">
                  <CheckCircle className="h-5 w-5 mr-3 text-green-500" />
                  <span className="text-gray-600 dark:text-gray-400">Unlimited modules</span>
                </li>
                <li className="flex items-center">
                  <CheckCircle className="h-5 w-5 mr-3 text-green-500" />
