    ...
    <div className="min-h-screen bg-white dark:bg-slate-900">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mt-8 mb-4">Information We Collect</h2>
          <p className="text-gray-600 dark:text-gray-400 mb-6">
            We collect information you provide directly to us, such as when you create an account, 
            use our services, or contact us for support.
          </p>

          <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mt-8 mb-4">How We Use Your Information</h2>
          ...
          <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mt-8 mb-4">Data Security</h2>
          <p className="text-gray-600 dark:text-gray-400 mb-6">
            We implement appropriate technical and organizational measures to protect your personal 
            information against unauthorized access, alteration, disclosure, or destruction.
          </p>

          <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mt-8 mb-4">Your Rights</h2>
          ...
          <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mt-8 mb-4">GDPR Compliance</h2>
          <p className="text-gray-600 dark:text-gray-400 mb-6">
            We are committed to compliance with the General Data Protection Regulation (GDPR) 
            and other applicable privacy laws.
          </p>

          <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mt-8 mb-4">Contact Us</h2>
          <p className="text-gray-600 dark:text-gray-400 mb-6">
          ...
          <div className="bg-blue-50 p-6 rounded-lg mt-8">
            <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">Questions About Privacy?</h3>
