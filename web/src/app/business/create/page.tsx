...
export default function CreateBusinessPage() {
    ...
    return (
      <div className="min-h-screen bg-v-background flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-v-text-secondary">Loading...</p>
        </div>
      </div>
    );
  }
  ...
  if (success) {
    return (
      <div className="min-h-screen bg-v-background flex items-center justify-center">
        <div className="bg-v-surface rounded-lg shadow-lg p-8 max-w-md w-full text-center">
          <CheckCircle className="w-16 h-16 text-green-500 mx-auto mb-4" />
          <h2 className="text-2xl font-bold text-v-text-primary mb-2">Business Created!</h2>
  ...
  return (
    <div className="min-h-screen bg-v-background py-12">
      <div className="max-w-2xl mx-auto px-4">
        <div className="bg-v-surface rounded-lg shadow-lg p-8">
          <div className="text-center mb-8">
            <Building2 className="w-16 h-16 text-blue-600 mx-auto mb-4" />
            <h1 className="text-3xl font-bold text-v-text-primary mb-2">Create Your Business</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={handleInputChange}
                  className="w-full px-3 py-2 border border-v-border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                >
