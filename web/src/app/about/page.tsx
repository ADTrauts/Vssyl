  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-900">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <h1 className="text-4xl font-bold text-gray-900 dark:text-gray-100 mb-8">About Vssyl</h1>
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mt-8 mb-4">What Makes Us Different</h2>
          ...
          <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mt-8 mb-4">Our Vision</h2>
          <p className="text-gray-600 dark:text-gray-400 mb-6">
