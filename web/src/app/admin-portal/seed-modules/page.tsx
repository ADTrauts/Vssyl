    ...
    <div className="container mx-auto p-6">
      <div className="max-w-4xl mx-auto">
        ...
        <Card className="p-6 mb-6">
          ...
          <p className="text-sm text-gray-700 dark:text-gray-300 dark:text-gray-400 mt-2 text-center">
          ...
          <Card className="p-6">
            ...
            <div className="grid grid-cols-2 gap-4 mb-4">
              <div className="p-4 bg-gray-50 dark:bg-slate-800 rounded-lg">
                <p className="text-sm text-gray-700 dark:text-gray-300">Modules Created</p>
                <p className="text-2xl font-bold text-gray-900 dark:text-gray-100">{results.modulesCreated}</p>
              </div>
              <div className="p-4 bg-gray-50 dark:bg-slate-800 rounded-lg">
                <p className="text-sm text-gray-700 dark:text-gray-300">Modules Updated</p>
                <p className="text-2xl font-bold text-gray-900 dark:text-gray-100">{results.modulesUpdated}</p>
              </div>
              <div className="p-4 bg-gray-50 dark:bg-slate-800 rounded-lg">
                <p className="text-sm text-gray-700 dark:text-gray-300">Businesses Processed</p>
                <p className="text-2xl font-bold text-gray-900 dark:text-gray-100">{results.businessesProcessed}</p>
              </div>
              <div className="p-4 bg-gray-50 dark:bg-slate-800 rounded-lg">
                <p className="text-sm text-gray-700 dark:text-gray-300">Installations Created</p>
                <p className="text-2xl font-bold text-gray-900 dark:text-gray-100">{results.installationsCreated}</p>
              </div>
            </div>

            {results.errors.length > 0 && (
              <div className="mt-4">
                <h4 className="text-sm font-semibold text-gray-900 dark:text-gray-100 mb-2">Errors:</h4>
