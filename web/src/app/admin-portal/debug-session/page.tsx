...
function DebugSessionPageContent() {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      ...
      <div className="bg-v-surface rounded-lg shadow p-6 mb-6">
      ...
      <div className="bg-v-surface rounded-lg shadow p-6 mb-6">
        ...
        <pre className="bg-v-surface-muted bg-v-surface-muted p-4 rounded text-sm overflow-auto">
      ...
      <div className="bg-v-surface rounded-lg shadow p-6">
        ...
        <div className="space-y-4">
          ...
          <button
            ...
            className="bg-v-surface-muted0 text-white px-4 py-2 rounded hover:bg-gray-600 ml-4"
          >
            Sign Out
          </button>
        </div>
