    ...
    <div className="min-h-screen bg-white dark:bg-slate-900">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mt-8 mb-4">Acceptance of Terms</h2>
          <p className="text-gray-600 dark:text-gray-400 mb-6">
            By accessing and using Vssyl, you accept and agree to be bound by the terms and 
            provision of this agreement.
          </p>

          <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mt-8 mb-4">Use License</h2>
          ...
          <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mt-8 mb-4">Prohibited Uses</h2>
          <p className="text-gray-600 dark:text-gray-400 mb-4">You may not use Vssyl:</p>
          <ul className="list-disc pl-6 text-gray-600 dark:text-gray-400 space-y-2 mb-6">
          ...
          <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mt-8 mb-4">Service Availability</h2>
          <p className="text-gray-600 dark:text-gray-400 mb-6">
            We strive to maintain 99.9% uptime but cannot guarantee uninterrupted service. 
            We reserve the right to modify or discontinue the service with reasonable notice.
          </p>

          <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mt-8 mb-4">Payment Terms</h2>
          <p className="text-gray-600 dark:text-gray-400 mb-6">
          ...
          <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mt-8 mb-4">Intellectual Property</h2>
          <p className="text-gray-600 dark:text-gray-400 mb-6">
            The service and its original content, features, and functionality are and will remain 
            the exclusive property of Vssyl and its licensors.
          </p>

          <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mt-8 mb-4">Limitation of Liability</h2>
          <p className="text-gray-600 dark:text-gray-400 mb-6">
          ...
          <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mt-8 mb-4">Contact Information</h2>
          <p className="text-gray-600 dark:text-gray-400 mb-6">
          ...
          <div className="bg-blue-50 p-6 rounded-lg mt-8">
            <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">Ready to Get Started?</h3>
            <p className="text-gray-600 dark:text-gray-400 mb-4">
