    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <Card className="p-8 text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-6">Please sign in to access household management.</p>
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          <Spinner size={32} />
          <p className="mt-4 text-gray-600 dark:text-gray-400">Loading household data...</p>
        </div>
      </div>
    );
  }
