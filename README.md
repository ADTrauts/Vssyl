...
- **GitHub Actions** (`.github/workflows/ci.yml`) runs on pushes and pull requests to this repo (type-check, Next.js production compile, tests, Postgres migrations in CI).
